...
export function getVisibleProviderOrLog(outputChannel: vscode.OutputChannel): ClineProvider | undefined {
	...
	if (!visibleProvider) {
		outputChannel.appendLine("Cannot find any visible NeonTractor instances.")
		return undefined
	}
...
export const openClineInNewTab = async ({ context, outputChannel }: Omit<RegisterCommandOptions, "provider">) => {
	...
	const newPanel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "Neon Tractor", targetCol, {
		enableScripts: true,
	...
	newPanel.iconPath = {
		light: vscode.Uri.joinPath(context.extensionUri, "assets", "images", "neontractor-logo.png"),
		dark: vscode.Uri.joinPath(context.extensionUri, "assets", "images", "neontractor-logo.png"),
	}
