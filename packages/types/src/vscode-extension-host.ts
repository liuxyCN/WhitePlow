...
export interface ExtensionMessage {
	type:
		...
		| "longTermMemoryAddFromTextResult"
		| "indexCleared"
		| "codebaseIndexConfig"
	...
	// ChinalifePE response properties
...
export interface WebviewMessage {
	...
	requestId?: string
	/** For apiRequestPreviewAck: matches showApiRequestPreview.values.previewId */
	previewId?: string
	ids?: string[]
