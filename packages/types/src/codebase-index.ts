...
export const codebaseIndexVectorStoreSchema = z.enum(["qdrant", "embedded"])
...
export const codebaseIndexConfigSchema = z.object({
	...
	codebaseIndexSearchMaxResults: z
		...
		.optional(),
	/**
	 * When true, the extension may run a vector search on the first user message of a task and inject related snippets (requires indexing ready).
	 */
	codebaseIndexAutoInjectOnFirstTurn: z.boolean().optional(),
...
export const codebaseIndexModelsSchema = z.object({
	...
	chinalifepe: z.record(z.string(), z.object({ dimension: z.number() })).optional(),
