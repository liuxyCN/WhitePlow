...
const chinalifePESchema = openAiSchema
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	chinalifePESchema.merge(z.object({ apiProvider: z.literal("chinalifepe") })),
...
> = {
	...
	chinalifepe: {
		id: "chinalifepe",
		label: "ChinalifePE",
		models: Object.keys(chinalifePEModels),
	},
